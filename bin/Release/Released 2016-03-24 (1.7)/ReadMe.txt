...
4. Known limitations
	...
	- CP/M support is still a promiss to be fulfilled
...
5. Known bugs
	...
	- Some Model 1's TRSDOS 2.x disks have a directory structure which may cause VDK-80 to skip (ignore) several files.
